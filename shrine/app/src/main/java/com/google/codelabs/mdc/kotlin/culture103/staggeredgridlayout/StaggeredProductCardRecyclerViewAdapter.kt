package com.google.codelabs.mdc.kotlin.culture103.staggeredgridlayout

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView

import com.google.codelabs.mdc.kotlin.culture103.R
import com.google.codelabs.mdc.kotlin.culture103.network.ImageRequester
import com.google.codelabs.mdc.kotlin.culture103.network.ProductEntry
...
class StaggeredProductCardRecyclerViewAdapter(private val productList: List<ProductEntry>?) : RecyclerView.Adapter<StaggeredProductCardViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): StaggeredProductCardViewHolder {
        var layoutId = R.layout.shr_product_card
        if (viewType == 1) {
            layoutId = R.layout.shr_product_card
        } else if (viewType == 2) {
            layoutId = R.layout.shr_product_card
        }
